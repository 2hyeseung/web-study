...
console.log("1 : "+div1.innerHTML); // 읽기
...
console.log("2 : "+div1.innerText); // 읽기
div1.innerText = '여기는 <b>첫번째</b> 태그입니다. &hearts;'; // 쓰기
console.log("3 : "+div1.innerText); // 읽기
div1.innerText = '안녕하세요!!'; // 쓰기

// textContent 속성
// : innerText와 마찬가지로 텍스트 정보를 표시
// IE9 이전 버전에서는 사용 불가능
console.log("4 : "+div1.textContent); // 읽기
...
console.log(h1.style.fontSize); //camel case로

h1.style.color='limegreen';
h1.style.backgroundColor='skyblue';
h1.style.border='4px solid brown';
h1.style.textShadow='4px 4px 14px #f005';
...
// for (let i=1;i<lis.length;i=i+2){
//     lis[i].classList.add("li2");
